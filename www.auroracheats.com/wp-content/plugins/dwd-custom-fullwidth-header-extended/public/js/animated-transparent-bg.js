...
jQuery(document).ready(function($) {
    ...
    function updateGradient() {
		...
		for(i=0;i<numItems;i++){
    		var gradientSpeed = $(".et_pb_fullwidth_header .et_pb_animated_transparent_bg").data('animated-gradient-speed');
            $(".et_pb_fullwidth_header_extended_" +i+ " .et_pb_bg_animated.et_pb_animated_transparent_bg").css({
